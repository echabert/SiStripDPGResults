...
// Margins:
  ...
  tdrStyle->SetPadLeftMargin(0.14); //JLA, 0.16 avant
...
// Margins:
  tdrStyle->SetPadTopMargin(0.05);
  tdrStyle->SetPadBottomMargin(0.13); 
  tdrStyle->SetPadLeftMargin(0.22); //JLA, 0.16 avant
...
// For the axis labels:
  ...
  tdrStyle->SetLabelSize(0.040, "XYZ"); //NEW
